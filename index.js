...
console.log(chalk.cyanBright.underline `-- Welcome to Student Management System-2024 (Admissions Open) -- `);
...
console.log(chalk.bold.redBright `You have Selected the Payment Method :${paymentType.payment}`);
